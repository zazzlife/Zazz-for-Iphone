...
-(CommentCell*)initWithComment:(Comment*)comment andReuseIdentifier:(NSString*)reuseIdentifier
{
    ...
    if (self) {
        ...
        self.commentLabel.frame = (CGRect){ .origin = {CGRectGetMaxX(self.iconView.frame)+ kCommentPaddingFromLeft, kCommentPaddingFromTop + 10}};
