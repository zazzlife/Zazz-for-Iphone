...
+(NSString*)urlEscapeString:(NSString *)unencodedString
{
    ...
    NSString *s = (__bridge_transfer NSString *)CFBridgingRelease(CFURLCreateStringByAddingPercentEscapes(NULL,originalStringRef, NULL, NULL,kCFStringEncodingUTF8));
